...
import NotificationContainer, { NotificationItem } from '../components/ui/NotificationContainer';
...
export function NotificationProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <NotificationContext.Provider value={{ showNotification, position, setPosition }}>
      {children}
