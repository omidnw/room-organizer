  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="quantity" className="block text-sm font-medium text-textPrimary mb-1">
            Quantity
          </label>
          <input
            type="number"
      ...
      {/* Purchase Date */}
      <div>
        <label htmlFor="purchaseDate" className="block text-sm font-medium text-textPrimary mb-1">
          Purchase Date
        </label>
        <input
          type="date"
        ...
        />
        {errors.purchaseDate && (
          <p className="mt-1 text-sm text-error">{errors.purchaseDate.message}</p>
        )}
      </div>
